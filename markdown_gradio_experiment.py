...
# This should be handled by the conda environment
# import os
# MY_API_KEY = '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'
...
# print(textwrap.fill(output, max_lines=10))
...
#     outputs=[gr.Textbox(label="ChatGPT response", show_copy_button=True, max_lines=10)],
